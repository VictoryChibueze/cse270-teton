...
class TestSmokeTest():
  ...
  def test_smokeTest(self):
    self.driver.get("http://127.0.0.1:5504/cse270/teton/1.6/index.html")
    self.driver.set_window_size(537, 816)
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("victory")
    self.driver.find_element(By.NAME, "lname").send_keys("chibueze")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("reoul")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Member")
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("victory4646")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("596jdjdkddk")
